...
document.querySelector(".block-link").addEventListener("click", (e) => {
    e.preventDefault();
    blockSection.scrollIntoView({ behavior: "smooth" });
});
...
// ========================================
// creating a block tabbed component
// ========================================

const por_btn = document.querySelector(".p-btns");
const p_btn = document.querySelectorAll(".p-btn");
const p_img_elem = document.querySelectorAll(".img-overlay");

por_btn.addEventListener("click", (e) => {
   ...
   // p_btn.forEach((curElem) => curElem.classList.remove("p-btn-active"));
    ...
    //   curElem.classList.remove("block-image-active")
    // );
    ...
    //img_div.forEach((curElem) =>
   //     curElem.classList.add("block-image-not-active")
   // );

   // img_active.forEach((curElem) =>
       // curElem.classList.remove(`block-image-not-active`)
   // );
});
